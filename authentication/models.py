...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    user_role = models.CharField(verbose_name='User role ', max_length=255, choices=ROLE_CHOICES, default=STUDENT, null=True)
...
class Student(models.Model):
    user_id = models.OneToOneField(verbose_name='User email ', to=User, primary_key=True, on_delete=models.CASCADE)
    
    courses_id = models.ManyToManyField(verbose_name='User courses ', to = Course, related_name = 'user_courses', blank=True)
...
class Teacher(models.Model):
    ...
    courses_id = models.ManyToManyField(verbose_name='Teacher courses ', to = Course, related_name = 'teacher_courses', blank=True)
